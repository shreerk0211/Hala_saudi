      ...
      <div className='homemain'>
         <div className='homebg'>
            ...
            <div className='home-content'>
               <p>People and culture<br /> Saudi Arabia has a rich culture <br /> shaped by the diversity of the people <br /> which has formed the basis of its <br /> culture identity.</p>
            </div>
            <div className='home-heading'>
               <h1>Explore <br /> Saudi Arabia</h1>
            </div>
         </div>
         <div className='page2'>
            <div className='page2-head'>
               <h1>Best Destinations</h1>
               <p>Explore the enchanting landscapes of Saudi Arabia, from <br /> the breathtaking deserts to the stunning coastal shores.</p>
            </div>
         ...
         <div className='page4'>
            <div className='page4-content'>
               <p>The Hisma Desert in Saudi Arabia is a realm of ethereal beauty that captivates the senses. Its vast <br />expanse of golden sand dunes, sculpted by the winds of time, creates a mesmerizing landscape <br />that stretches as far as the eye can see. As the sun sets, painting the sky with vivid hues.</p>
            </div>
