      ...
      <div className="trip-container">
        ...
        <div className="trip-options">
          <div className="trip-option option1" onClick={handleIconClick}>
            ...
            <p>Build single city or multicity trips with flights, hotels, activities, airport transfers and pay in 1-click for it all</p>
          </div>
          <div className="trip-option option2" onClick={handleIconClick}>
            ...
            <p>Compare trips to find the best value for your time & money. Scan states/regions/countries/continents</p>
          </div>
          <div className="trip-option option3" onClick={handleIconClick}>
            ...
            <h3>Inspire Me</h3>
            <p>Find your next travel destination! Billions of data points pulled-in to find you the most suitable destinations</p>
          </div>
        </div>
      </div>
      {showForm && (
